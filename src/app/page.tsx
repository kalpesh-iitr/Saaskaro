    ...
    <div className="bg-[#ffffff] px-6 md:px-28 flex flex-col md:flex-row justify-between items-center">
      <div className="flex flex-col text-left text-[#000000] w-full md:w-1/2 mb-8 md:mb-0">
        ...
        <div className="text-lg md:text-xl mt-4">
          Streamline your operations with SaasKaro - the ultimate solution for SMSEs/MSMEs
        </div>
        <div className="flex mt-8">
          <Button customClassName="blue_btn" onClick={handleGetStarted} text="Get Started for Free"/>
          <Button customClassName="white_btn ml-4" onClick={handleGetStarted} text="Contact Us"/>
        </div> 
      </div>
